...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if (!permissions.has("SPEAK"))return sendError("من نمی توانم به کانال صوتی شما متصل شوم، مطمئن شوید که مجوزهای لازم را دارم!", message.channel);
   ...
   var serverQueue = message.client.queue.get(message.guild.id);
    ...
    if (serverQueue) {
      ...
      .setColor("YELLOW")
      .addField("نام", song.title, true)
      .addField("مدت زمان", song.duration, true)
      .addField("درخواست شده توسط", song.req.tag, true)
      .setFooter(`بازدیدها: ${song.views} | ${song.ago}`)
...
stream.on('error', function(er)  {
    ...
    queue.connection.on("disconnect", () => message.client.queue.delete(message.guild.id));
      ...
      let thing = new MessageEmbed()
      .setAuthor("شروع به پخش موسیقی کرد!", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
      .setThumbnail(song.img)
      .setColor("BLUE")
      .addField("نام", song.title, true)
      .addField("مدت زمان", song.duration, true)
